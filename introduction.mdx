...
- **Financial market data** - Tick data, trades, order books, OHLC, with specialized [finance functions](https://questdb.com/docs/reference/function/finance/) and [orderbook analytics](https://questdb.com/docs/guides/order-book/)
...
<CardGroup cols={2}>
  ...
  <Card title="Connect & Ingest" icon="plug" href="/connect">
    Learn about ingestion clients and connection methods
  </Card>
  
  <Card title="SQL Reference" icon="book" href="/sql-reference">
